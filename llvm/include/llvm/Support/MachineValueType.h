...
namespace llvm {
  ...
  public:
    enum SimpleValueType : uint8_t {
      ...
      v32f16         =  77,   //   32 x f16
      v64f16         =  78,   //   64 x f16
      v128f16        =  79,   //  128 x f16
      v256f16        =  80,   //  256 x f16
      v2bf16         =  81,   //    2 x bf16
      v3bf16         =  82,   //    3 x bf16
      v4bf16         =  83,   //    4 x bf16
      v8bf16         =  84,   //    8 x bf16
      v16bf16        =  85,   //   16 x bf16
      v32bf16        =  86,   //   32 x bf16
      v64bf16        =  87,   //   64 x bf16
      v128bf16       =  88,   //  128 x bf16
      v1f32          =  89,   //    1 x f32
      v2f32          =  90,   //    2 x f32
      v3f32          =  91,   //    3 x f32
      v4f32          =  92,   //    4 x f32
      ...
      v32f32         =  96,   //   32 x f32
      v64f32         =  97,   //   64 x f32
      v128f32        =  98,   //  128 x f32
      v256f32        =  99,   //  256 x f32
      v512f32        = 100,   //  512 x f32
      v1024f32       = 101,   // 1024 x f32
      v2048f32       = 102,   // 2048 x f32
      v1f64          = 103,   //    1 x f64
      v2f64          = 104,   //    2 x f64
      v4f64          = 105,   //    4 x f64
      v8f64          = 106,   //    8 x f64
      ...
      v32f64         = 108,   //   32 x f64
      v64f64         = 109,   //   64 x f64
      v128f64        = 110,   //  128 x f64
      v256f64        = 111,   //  256 x f64
      ...
      nxv1i1         = 112,   // n x  1 x i1
      nxv2i1         = 113,   // n x  2 x i1
      nxv4i1         = 114,   // n x  4 x i1
      nxv8i1         = 115,   // n x  8 x i1
      nxv16i1        = 116,   // n x 16 x i1
      nxv32i1        = 117,   // n x 32 x i1
      nxv64i1        = 118,   // n x  64 x i1

      nxv1i8         = 119,   // n x  1 x i8
      nxv2i8         = 120,   // n x  2 x i8
      nxv4i8         = 121,   // n x  4 x i8
      nxv8i8         = 122,   // n x  8 x i8
      nxv16i8        = 123,   // n x 16 x i8
      nxv32i8        = 124,   // n x 32 x i8
      nxv64i8        = 125,   // n x  64 x i8

      nxv1i16        = 126,  // n x  1 x i16
      nxv2i16        = 127,  // n x  2 x i16
      nxv4i16        = 128,  // n x  4 x i16
      nxv8i16        = 129,  // n x  8 x i16
      nxv16i16       = 130,  // n x 16 x i16
      nxv32i16       = 131,  // n x 32 x i16

      nxv1i32        = 132,  // n x  1 x i32
      nxv2i32        = 133,  // n x  2 x i32
      nxv4i32        = 134,  // n x  4 x i32
      nxv8i32        = 135,  // n x  8 x i32
      nxv16i32       = 136,  // n x 16 x i32
      nxv32i32       = 137,  // n x 32 x i32

      nxv1i64        = 138,  // n x  1 x i64
      nxv2i64        = 139,  // n x  2 x i64
      nxv4i64        = 140,  // n x  4 x i64
      nxv8i64        = 141,  // n x  8 x i64
      nxv16i64       = 142,  // n x 16 x i64
      nxv32i64       = 143,  // n x 32 x i64

      FIRST_INTEGER_SCALABLE_VECTOR_VALUETYPE = nxv1i1,
      LAST_INTEGER_SCALABLE_VECTOR_VALUETYPE = nxv32i64,

      nxv1f16        = 144,   // n x   1 x f16
      nxv2f16        = 145,  // n x  2 x f16
      nxv4f16        = 146,  // n x  4 x f16
      nxv8f16        = 147,  // n x  8 x f16
      nxv16f16       = 148,   // n x  16 x f16
      nxv32f16       = 149,   // n x  32 x f16
      nxv2bf16       = 150,  // n x  2 x bf16
      nxv4bf16       = 151,  // n x  4 x bf16
      nxv8bf16       = 152,  // n x  8 x bf16
      nxv1f32        = 153,  // n x  1 x f32
      nxv2f32        = 154,  // n x  2 x f32
      nxv4f32        = 155,  // n x  4 x f32
      nxv8f32        = 156,  // n x  8 x f32
      nxv16f32       = 157,  // n x 16 x f32
      nxv1f64        = 158,  // n x  1 x f64
      nxv2f64        = 159,  // n x  2 x f64
      nxv4f64        = 160,  // n x  4 x f64
      nxv8f64        = 161,  // n x  8 x f64
      ...
      x86mmx         = 162,   // This is an X86 MMX value

      Glue           = 163,   // This glues nodes together during pre-RA sched

      isVoid         = 164,   // This has no value

      Untyped        = 165,   // This value takes a register, but has
                              // unspecified type.  The register class
                              // will be determined by the opcode.

      funcref        = 166,   // WebAssembly's funcref type
      externref      = 167,   // WebAssembly's externref type
      x86amx         = 168,   // This is an X86 AMX value
